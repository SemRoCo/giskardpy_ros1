...
from giskardpy_ros1.configs.collision_avoidance_config import CollisionAvoidanceConfig
from giskardpy_ros1.configs.robot_interface_config import StandAloneRobotInterfaceConfig, RobotInterfaceConfig
