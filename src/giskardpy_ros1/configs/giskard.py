...
from giskardpy_ros1.configs.behavior_tree_config import BehaviorTreeConfig, OpenLoopBTConfig
from giskardpy.god_map import god_map
from giskardpy_ros1.configs.collision_avoidance_config import CollisionAvoidanceConfig, DisableCollisionAvoidanceConfig
from giskardpy_ros1.configs.qp_controller_config import QPControllerConfig
from giskardpy_ros1.configs.robot_interface_config import RobotInterfaceConfig
from giskardpy_ros1.configs.world_config import WorldConfig
...
class Giskard:
    ...
    def __init__(self,
        ...
        :param additional_monitor_package_paths: specify paths that Giskard needs to import to find your custom Monitors.
                                              ...
                                              path in the list.
        """
        god_map.tmp_folder = resolve_ros_iris('package://giskardpy_ros1/tmp/')
